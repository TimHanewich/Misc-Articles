...
The UART Rx buffer size differs between devices, but I've seen buffers grow to more than 268,540 bytes. If the buffer exceeds this length, old bytes will be lapsed and be "overwritten" with new bytes (continuous stream with a cutoff).
